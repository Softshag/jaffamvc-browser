...
let List = JaffaMVC.List = class List {
    /**
...
let Channel = JaffaMVC.Channel = class Channel extends JaffaMVC.Object {
    /**
     * Channel
...
let Module = JaffaMVC.Module = class Module extends JaffaMVC.Object {
    get startWithParent() {
...
JaffaMVC.Region = class Region extends JaffaMVC.Object {
    /**
...
JaffaMVC.RegionManager = class RegionManager extends JaffaMVC.Object {
    constructor() {
        this.regions = {};
        super();
    }
...
JaffaMVC.NativeView = class NativeView extends BBView {
    constructor(...args) {
        this._domEvents = [];
        super(...args);
    }
...
JaffaMVC.View = class View extends JaffaMVC.NativeView {
    /**
     * Base View
...
let LayoutView = JaffaMVC.LayoutView = class LayoutView extends JaffaMVC.View {
    /**
     * LayoutView
...
let CollectionView = JaffaMVC.CollectionView = class CollectionView extends JaffaMVC.View {
...
let Application = JaffaMVC.Application = class Application extends JaffaMVC.Module {
    /**
...
export let View = JaffaMVC.View;
export {
    Module, View, CollectionView, LayoutView, View
};
